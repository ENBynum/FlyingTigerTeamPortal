export const AbsenceTypes = ['Excused/Absence Authorized', 'Excused/RST Authorized', 'Excused/ET Authorized', 'Exception of Unexcused Absence']
export const AbsenceTypeToolTips = [
	{
...
export const MakeUpUniforms = ['ACU', 'PT', 'ASU']